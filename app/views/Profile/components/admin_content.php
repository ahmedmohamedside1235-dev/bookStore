<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="admins-pane" role="tabpanel" aria-labelledby="admins"
        tabindex="0">
        <?php require_once __DIR__ . "/admins.cards.php"; ?>
    </div>
    <div class="tab-pane fade" id="customers-pane" role="tabpanel" aria-labelledby="customers"
        tabindex="0">
        <?php require_once __DIR__ . "/customers.cards.php"; ?>
    </div>
    <div class="tab-pane fade" id="authors-pane" role="tabpanel" aria-labelledby="authors"
        tabindex="0">
        <?php require_once __DIR__ . "/authors.cards.php"; ?>
    </div>
    <div class="tab-pane fade" id="books-pane" role="tabpanel" aria-labelledby="books"
        tabindex="0">
        <div id="BookFilter">
            <form class="p-3 plg-5 mb-4" id="BookFilterForm">
                <div class="row">
                    <div class="col-md-6">
                        <div class="item">
