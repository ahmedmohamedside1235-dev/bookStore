...
<ul class="nav nav-tabs mb-4 d-flex justify-content-center align-items-center" id="myTab" role="tablist">
    ...
    <button type="button" class="btn iconCart position-relative ms-2 ms-lg-auto" onclick="getitemsIntoCart(this)">
        <i class="fa-solid fa-cart-shopping"></i>
        <span class="position-absolute top-0 start-100 translate-middle badge">
            <span id="NumberOfOrders"><?= $total['totalitemsIntoCart'] ?></span>
        </span>
    </button>
</ul>